#Methods are also functions but methods are the functions inside class
# Methods must be called with class object
...
# vowels.remove("2")#This raises error:ValueError
